...
/// This should be discussed with the Backend Engineer to get a List of Errors from the Rest API. Any errors available from this app can be determined here
class ErrorConst {
