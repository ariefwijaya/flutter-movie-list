...
import 'package:flutter_movie_list/modules/movie_list/screens/movie_detail_screen.dart';
    ...
    switch (routeSettings.name) {
      ...
      case RouterConst.detail:
        return MaterialPageRoute(
            builder: (_) => MovieDetailScreen(detail: routeSettings.arguments as MovieModel,), settings: routeSettings);
